...
architecture Behavioral of replication is
    ...
    signal checker : unsigned (log2c(number_of_replication) - 1 downto 0) := (to_unsigned(number_of_replication - 1, log2c(number_of_replication)));
...
begin
    ...
    --tj kada se potrose svi rezervni moduli izlaz fizicki postaje 0
